        ...
        vNavigation.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.menu_feed:
                        Toast.makeText(getApplicationContext(), "click feed", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_direct:
                        Toast.makeText(getApplicationContext(), "click menu_direct", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menu_news:
                        Toast.makeText(getApplicationContext(), "click menu_news", Toast.LENGTH_SHORT).show();
                        break;
